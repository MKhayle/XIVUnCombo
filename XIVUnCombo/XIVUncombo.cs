...
public sealed partial class XIVUncombo : IDalamudPlugin
{
    ...
    private void OnOpenConfigUi()
    {
        ...
        {
            string job = Service.ObjectTable.LocalPlayer?.ClassJob.RowId != null ? CustomUncomboInfoAttribute.JobIDToName((byte)Service.ObjectTable.LocalPlayer?.ClassJob.RowId) : Service.Configuration.CurrentJobTab;
